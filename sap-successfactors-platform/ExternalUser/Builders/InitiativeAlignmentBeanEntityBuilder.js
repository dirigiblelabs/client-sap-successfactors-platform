var method = InitiativeAlignmentBeanEntityBuilder.prototype;

function InitiativeAlignmentBeanEntityBuilder() {
...
method.goalId = function(goalId) {
	this.goalId = goalId;
	return this;
};

method.goalName = function(goalName) {
	this.goalName = goalName;
	return this;
};

method.goalType = function(goalType) {
	this.goalType = goalType;
	return this;
};

method.initiativeGroupBeanRowId = function(initiativeGroupBeanRowId) {
	this.initiativeGroupBeanRowId = initiativeGroupBeanRowId;
	return this;
};

method.initiativeId = function(initiativeId) {
	this.initiativeId = initiativeId;
	return this;
};

method.initiativeName = function(initiativeName) {
...
method.build = function() {
	return {
		...
		initiativeGroupBeanRowId: this.initiativeGroupBeanRowId,
...
module.exports = InitiativeAlignmentBeanEntityBuilder;
