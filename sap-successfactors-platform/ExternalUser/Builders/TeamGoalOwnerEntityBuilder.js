var method = TeamGoalOwnerEntityBuilder.prototype;

function TeamGoalOwnerEntityBuilder() {
...
method.objId = function(objId) {
	this.objId = objId;
	return this;
};

method.ownerType = function(ownerType) {
...
module.exports = TeamGoalOwnerEntityBuilder;
