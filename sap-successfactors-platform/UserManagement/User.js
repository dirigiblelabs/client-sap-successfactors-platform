...
var UserEntityBuilder = require("sap-successfactors-platform/UserManagement/Builders/UserEntityBuilder");
...
exports.getClient = function(configurations) {
	return new UserClient(configurations);
};

exports.getClientAsync = function(configurations) {
	return new UserClientAsync(configurations);
};

function UserClient (configurations) {

	var API_PATH = "/odata/v2/User";
...
function UserClientAsync (configurations) {
